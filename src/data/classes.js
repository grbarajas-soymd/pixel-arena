...
export const CLASSES = {
  wizard: {
    ...
    desc: '4200 HP · 650 Mana · Staff 95dmg\nChain Lightning · Lightning Bolt\nStatic Shield · Thunderstorm',
    color: '#44ddbb', colorDark: '#1a6a5a', colorLight: '#88ffdd',
    hp: 4200, mana: 650, manaRegen: 5.5, baseDmg: 95, baseAS: 0.75, def: 45, evasion: 0,
  ...
  assassin: {
    ...
    hp: 4800, energy: 100, energyRegen: 14, baseDmg: 175, baseAS: 1.4, def: 42, evasion: 0.15,
  ...
  barbarian: {
    ...
    hp: 5500, baseDmg: 230, baseAS: 0.85, def: 65, evasion: 0,
    ...
    lifesteal: 0.025, stunResist: 0.5, slowResist: 0.40,
